...
export interface ApiAcademicruleAcademicrule
  ...
  info: {
    description: '';
    displayName: 'academicrule';
    pluralName: 'academicrules';
    singularName: 'academicrule';
  };
  options: {
  ...
  attributes: {
    ...
    grading: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::academicrule.academicrule'
    > &
      Schema.Attribute.Private;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coursetype: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiElectivecourseElectivecourse
  extends Struct.CollectionTypeSchema {
  collectionName: 'electivecourses';
  info: {
    displayName: 'electivecourse';
    pluralName: 'electivecourses';
    singularName: 'electivecourse';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::electivecourse.electivecourse'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTalkAndEventTalkAndEvent
  extends Struct.CollectionTypeSchema {
  collectionName: 'talk_and_events';
  info: {
    description: '';
    displayName: 'Talk and event';
    pluralName: 'talk-and-events';
    singularName: 'talk-and-event';
  };
  options: {
    draftAndPublish: true;
  };
